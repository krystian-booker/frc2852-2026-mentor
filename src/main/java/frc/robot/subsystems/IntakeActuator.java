...
public class IntakeActuator extends SubsystemBase {
  ...
  public void driveExtend() {
    closedLoopController.setSetpoint(
        IntakeActuatorConstants.EXTENDED_POSITION, SparkBase.ControlType.kPosition);
  }

  public void driveRetractAg() {
    closedLoopController.setSetpoint(
        IntakeActuatorConstants.RETRACTED_POSITION_AG, SparkBase.ControlType.kPosition);
  }

  public void driveRetract() {
    closedLoopController.setSetpoint(
        IntakeActuatorConstants.RETRACTED_POSITION, SparkBase.ControlType.kPosition);
  }
  ...
  public boolean isExtended() {
    return Math.abs(encoder.getPosition() - IntakeActuatorConstants.EXTENDED_POSITION)
        <= IntakeActuatorConstants.POSITION_TOLERANCE_ROTATIONS;
  }

  public boolean isRetracted() {
    return Math.abs(encoder.getPosition() - IntakeActuatorConstants.RETRACTED_POSITION)
        <= IntakeActuatorConstants.POSITION_TOLERANCE_ROTATIONS;
  }
    ...
    return run(() ->
            motor.set(
                SmartDashboard.getNumber(
                    "IntakeActuator/StepTestDutyCycle",
