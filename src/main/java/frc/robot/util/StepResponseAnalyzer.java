...
/**
 * Records position-vs-time samples during step tests and computes step response metrics:
...
public class StepResponseAnalyzer {
    ...
    /**
     * Time until position stays within tolerance of target permanently (seconds).
