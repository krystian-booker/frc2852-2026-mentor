...
public class Telemetry {
  ...
  public void telemeterize(SwerveDriveState state) {
    ...
    gridColPub.set(Math.max(0, Math.min(CalibrationConstants.GRID_COLS - 1,
        (int) ((robotX - CalibrationConstants.CALIBRATION_START_X) / CalibrationConstants.GRID_CELL_SIZE_METERS))));
    gridRowPub.set(Math.max(0, Math.min(CalibrationConstants.GRID_ROWS - 1,
        (int) ((robotY - CalibrationConstants.CALIBRATION_START_Y) / CalibrationConstants.GRID_CELL_SIZE_METERS))));
