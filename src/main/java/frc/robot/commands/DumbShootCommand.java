 ...
 * aiming calculator. The drivetrain is held stationary (no wiggle). Runs until interrupted.
 */
public class DumbShootCommand extends Command {
  ...
  public DumbShootCommand(
      Flywheel flywheel, Hood hood, Indexer indexer, IntakeActuator intakeActuator) {
