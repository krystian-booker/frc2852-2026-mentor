...
public class RobotContainer {
    ...
    /**
     * Configure disabled mode bindings for QuestNav seeding. LEDs start RED and turn GREEN once QuestNav is seeded from
     * a multi-tag vision pose. Seeding only happens while disabled, every 5 seconds. If the robot is moved after
